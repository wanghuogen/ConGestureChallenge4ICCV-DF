...
ftrain = fopen('DFDI4caffe/train/train_depth_DFDI.txt','w');  %Genarate the training list for caffe
fval = fopen('DFDI4caffe/train/val_depth_DFDI.txt','w');   %Generate the validation list for caffe
